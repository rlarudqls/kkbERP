...
import com.kkbERP.erp.form.EmployeeAddform;
...
import com.kkbERP.erp.service.HrhistoryService;
import com.kkbERP.erp.service.JobGradeService;
import com.kkbERP.erp.service.ManagementService;
import com.kkbERP.erp.service.PayrollTableService;
...
public class HrController {
	...
	@ResponseBody
	public int calculateTotalPayment(@RequestParam("payMonth") String payMonth, @RequestParam("empNos") String[] selectedEmpNos, @RequestParam("payType") String paymentType) {
	...
	public String registerPayroll(@RequestParam("payDate") String payrollDate, @RequestParam("payMonth") String payrollMonth,
	...
	@RequestMapping("/search_management.erp") public String searchManagement() {
		return "hr/search_management"; 
	}
}

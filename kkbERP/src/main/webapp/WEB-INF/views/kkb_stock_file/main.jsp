...
<div class="container-fluid col-sm-9" style="margin-left:250px; padding: 50px 0px;">
	...
	<div class="row">
		<div class="col-sm-6">
			<img src="../resources/images/logo/stockmain.jpg" class="img-rounded" style="width: 100%">
		</div>
				...
				<div class="col-md-11" style="font-weight: bold">
					...
					<div class="panel panel-default" style="margin-top: -5px;">
						...
						<div class="panel-body">
							<a href="inquiryByStore.erp" class="w3-bar-item w3-button w3-right-align">지점별 재고 조회</a>
    						<a href="inquiryByProduct.erp" class="w3-bar-item w3-button w3-right-align">제품별 재고 조회</a>
						</div>
					</div>
				</div>
			</div>
